...
<style>
  ...
  * { box-sizing:border-box; margin:0; }
  ...
  .readpill { font:11px ui-monospace,monospace; background:rgba(255,179,92,.12); color:#FFCE8A !important;
              border-radius:5px; padding:2px 8px; text-decoration:none; margin-left:8px; vertical-align:2px; }
  .readpill:hover { background:rgba(255,179,92,.25); }
...
<section id="ch11" data-title="Running your game">
  ...
  <p>Everything lives in <a id="folderlink" href="#">the game folder</a> as <b>.bat</b>
  files - the same folder this page lives in. You run one by <b>double-clicking it in that
  folder</b> - not from this page (browsers are not allowed to start programs on your
  computer, which is honestly for the best). The little <i>read the script</i> pills open
  each one in VS Code, because none of them are magic - just steps you can read.</p>

  <div class="mission"><div class="lvl">PLAY</div><h4>Sundown Run.bat <a class="readpill" data-file="Sundown Run.bat" data-line="1">read the script</a></h4>
  ...
  <div class="mission"><div class="lvl">MULTIPLAYER</div><h4>Sundown Run Multiplayer.bat <a class="readpill" data-file="Sundown Run Multiplayer.bat" data-line="1">read the script</a></h4>
  ...
  <div class="mission"><div class="lvl">MAP</div><h4>Sundown Run Map Gen.bat <a class="readpill" data-file="Sundown Run Map Gen.bat" data-line="1">read the script</a></h4>
  ...
  <div class="mission"><div class="lvl">UPDATE / DO-OVER</div><h4>Sundown Run Update.bat <a class="readpill" data-file="Sundown Run Update.bat" data-line="1">read the script</a></h4>
...
const fileRoot = location.protocol === 'file:'
  ...
  : null;
// "the game folder": this page lives in it, so its own URL minus the filename
// IS the folder. A file:// folder link opens the browser's file listing (not
// Explorer - pages cannot do that), which shows where everything lives.
const fl = document.getElementById('folderlink');
if (fl && location.protocol === 'file:') {
  fl.href = location.href.replace(/\\/[^/]*$/, '/');
} else if (fl) {
  fl.href = GH.replace(/blob\\/main\\/$/, '');
}
